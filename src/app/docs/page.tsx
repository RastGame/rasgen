    ...
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <Link href="/docs" className={styles.navLinkActive}>
            Documentation
          </Link>
      ...
      <main className={styles.main}>
        <div className={styles.sidebar}>
          ...
          <ul className={styles.sidebarList}>
            ...
            <li className={styles.sidebarItem}>
              <a href="#getting-started" className={styles.sidebarLink}>
                Getting Started
              </a>
            </li>
            <li className={styles.sidebarItem}>
              <a href="#api-reference" className={styles.sidebarLink}>
                API Reference
              </a>
              <ul className={styles.sidebarSublist}>
                <li className={styles.sidebarSubitem}>
                  <a href="#badge-api" className={styles.sidebarSublink}>
                    Badge API
                  </a>
                </li>
                <li className={styles.sidebarSubitem}>
                  <a href="#github-api" className={styles.sidebarSublink}>
                    GitHub API
                  </a>
                </li>
                <li className={styles.sidebarSubitem}>
                  <a href="#npm-api" className={styles.sidebarSublink}>
                    NPM API
                  </a>
                </li>
              </ul>
            ...
            <li className={styles.sidebarItem}>
              <a href="#styling" className={styles.sidebarLink}>
                Styling Options
              </a>
            </li>
            <li className={styles.sidebarItem}>
              <a href="#advanced" className={styles.sidebarLink}>
                Advanced Usage
              </a>
            </li>
          </ul>
        ...
        <div className={styles.content}>
          <section id="introduction" className={styles.section}>
            ...
            <p className={styles.description}>
              ...
              repositories, documentation, and websites. This documentation will
              help you get started with using Rasgen and provide detailed
          ...
          <section id="getting-started" className={styles.section}>
            ...
            <p>
              Using Rasgen is simple. You can create badges by making requests
              to our API endpoints with the appropriate parameters. The basic
              format for a badge URL is:
            </p>
            <div className={styles.codeBlock}>
              <code>
                https://rasgen.vercel.app/api/badge?label=LABEL&message=MESSAGE&color=COLOR
              </code>
            </div>
            <p>
              This will generate a badge with the specified label, message, and
              color. You can then use this URL in your markdown files, HTML
              pages, or anywhere else you want to display the badge.
            </p>
          </section>
          ...
          <section id="api-reference" className={styles.section}>
            ...
            <p>
              Rasgen provides several API endpoints for generating different
              types of badges. Here&apos;s a detailed reference for each
              endpoint.
            </p>
            ...
            <div id="badge-api" className={styles.subsection}>
              ...
              <p>
                The Badge API allows you to create custom badges with your own
                text and colors.
              </p>
                ...
                <table className={styles.parametersTable}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>string</td>
                      <td>
                        The color of the right side of the badge (e.g.,
                        &ldquo;blue&rdquo;, &ldquo;green&rdquo;,
                        &ldquo;red&rdquo;)
                      </td>
                      <td>No (default: &ldquo;blue&rdquo;)</td>
                    </tr>
                    <tr>
                      <td>style</td>
                      <td>string</td>
                      <td>
                        The style of the badge (e.g., &ldquo;flat&rdquo;,
                        &ldquo;flat-square&rdquo;, &ldquo;plastic&rdquo;)
                      </td>
                      <td>No (default: &ldquo;flat&rdquo;)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div id="github-api" className={styles.subsection}>
              ...
              <p>
                The GitHub API allows you to create badges based on GitHub
                repository data.
              </p>
              <div className={styles.apiEndpoint}>
                <h4 className={styles.endpointTitle}>Endpoint</h4>
                ...
                <table className={styles.parametersTable}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>string</td>
                      <td>
                        GitHub repository in format &ldquo;username/repo&rdquo;
                      </td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                      ...
                      <td>string</td>
                      <td>
                        Type of badge (e.g., &ldquo;stars&rdquo;,
                        &ldquo;forks&rdquo;, &ldquo;issues&rdquo;,
                        &ldquo;license&rdquo;)
                      </td>
                      <td>No (default: &ldquo;stars&rdquo;)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div className={styles.apiExample}>
                ...
                <div className={styles.exampleResult}>
                  <p>
                    This will generate a badge showing the number of stars for
                    the yurbaone/badgen repository.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="npm-api" className={styles.subsection}>
              ...
              <p>
                The NPM API allows you to create badges based on NPM package
                data.
              </p>
              <div className={styles.apiEndpoint}>
                <h4 className={styles.endpointTitle}>Endpoint</h4>
                ...
                <table className={styles.parametersTable}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>string</td>
                      <td>
                        Type of badge (e.g., &ldquo;version&rdquo;,
                        &ldquo;downloads&rdquo;, &ldquo;license&rdquo;)
                      </td>
                      <td>No (default: &ldquo;version&rdquo;)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div className={styles.apiExample}>
                ...
                <div className={styles.exampleResult}>
                  <p>
                    This will generate a badge showing the latest version of the
          ...
          <section id="styling" className={styles.section}>
            ...
            <p>
              Rasgen supports various styling options for badges. You can
              customize the appearance of your badges using the{" "}
          ...
          <section id="advanced" className={styles.section}>
            ...
            <p>
              For advanced usage scenarios, you can combine multiple badges or
              create custom integrations with your own services.
            </p>
            <h3>Custom Integration Example</h3>
            <p>
              If you want to create a badge that updates based on your own API
              or service, you can create a serverless function that fetches data
              from your service and then redirects to the Rasgen API with the
